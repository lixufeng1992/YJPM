...
import("@.Model.CommonDao");
	class SubcontractDocumentOriginDao extends CommonDao{
		public function findAll(){
			
			$sql="select * from tb_subcontract_document_origin order by documentid asc";
		...
		public function findById($documentid){
			...
			$sql="select * from tb_subcontract_document_origin where documentid=?";
		...
		public function findByContractid($contractid){
			...
			$sql="select * from tb_subcontract_document_origin where contractid=?";
			$statement = $this->commonPDO->prepare($sql);
		...
		public function add($contractid,$name,$path,$remark){
			...
			$sql="insert into tb_subcontract_document_origin(contractid,name,path,remark) values(?,?,?,?)";
			$statement = $this->commonPDO->prepare($sql);
		...
		public function updateById($documentid,$contractid,$name,$path,$remark){
			...
			$sql="update tb_subcontract_document_origin set contractid=?,name=?,path=?,remark=? where documentid=?";
			$statement = $this->commonPDO->prepare($sql);
		...
		public function deleteById($documentid){
			...
			$sql="delete from tb_subcontract_document_origin where documentid=?";
			$statement = $this->commonPDO->prepare($sql);
